...
```{r}
filn <- "US-PFa-WLEF-TallTowerClean-2012-L0-vFeb2013.nc"
url <- "http://co2.aos.wisc.edu/data/cheas/wlef/netcdf/"
cmd <- paste0("wget ", url, filn)
if (!file.exists(filn)){
  system(cmd)
}
```
...
wlef = nc_open(filn)  ## 'filn' is defined in the chunk above.
print(wlef)    ## metadata
```
